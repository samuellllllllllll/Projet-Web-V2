...
import { WarnData, Warner } from './warn-method.js';
...
export declare class WriteEntry extends Minipass<Buffer> implements Warner {
    #private;
    path: string;
    portable: boolean;
    myuid: number;
...
export declare class WriteEntryTar extends Minipass<Buffer> implements Warner {
    blockLen: number;
    blockRemain: number;
    buf: number;
    pos: number;
